...
func TestPullUnauthorizedEmitsUnifiedErrorEnvelope(t *testing.T) {
	repo := newTestSeedRepository(t)
	...
	command.SetArgs([]string{"--branch", "main"})
	if err := command.Execute(); err == nil {
		t.Fatal("execute pull: expected error")
	}
...
func TestPullBadRequestEmitsUnifiedErrorEnvelope(t *testing.T) {
	repo := newTestSeedRepository(t)
...
func TestPullInternalErrorEmitsUnifiedErrorEnvelope(t *testing.T) {
	repo := newTestSeedRepository(t)
...
func TestPullUnreachableRemoteEmitsUnifiedErrorEnvelope(t *testing.T) {
	repo := newTestSeedRepository(t)
